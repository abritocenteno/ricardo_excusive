  ...
  return (
    <div className="relative bg-surface">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <Image
          src="/images/WhatsApp_Image_2025-09-13_at_17.40.18.jpeg"
          alt=""
          fill
      ...
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/road-track-gt-r-9-1645043420.avif')",
      ...
      <section className="bg-surface-container-low border-t border-outline-variant">
        <div className="max-w-5xl mx-auto px-4 py-12 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            ...
            <a
              href={`mailto:ricardo.exclusives@hotmail.com?subject=${encodeURIComponent('Interesse in een voertuig')}&body=${encodeURIComponent('Hallo,\n\nIk heb interesse in een voertuig uit uw aanbod. Kunt u mij meer informatie geven?\n\nMet vriendelijke groet,')}`}
              className="inline-flex items-center justify-center gap-2 border border-white/20 hover:border-white/40 hover:bg-white/5 text-white font-semibold px-6 py-3 rounded-xl transition-all"
            >
